...
dataSet = "mc16e_new_trackCleaning"

plotType = "truthMVMass"
...
for ntrk in ntrkList:
    massDict[ntrk] = r.TH1D("mv_"+ntrk, ";m_{MV} [GeV]", 100, 0., 100.)
    massDict_passFiducialCut[ntrk] = r.TH1D("mv_passFiducialCut"+ntrk, ";m_{MV} [GeV]", 100, 0., 100.)
    massDict_passDistCut[ntrk] = r.TH1D("mv_passDistCut"+ntrk, ";m_{MV} [GeV]", 100, 0., 100.)
    massDict_passChi2Cut[ntrk] = r.TH1D("mv_passChi2Cut"+ntrk, ";m_{MV} [GeV]", 100, 0., 100.)
    massDict_matVeto[ntrk] = r.TH1D("mv_matVeto"+ntrk, ";m_{MV} [GeV]", 100, 0., 100.)
    massDict_passDVsel[ntrk] = r.TH1D("mv_passDVsel"+ntrk, ";m_{MV} [GeV]", 100, 0., 100.)
...
for dv in tree:
    ...
    # Is the DV satisfy MV definition?
    if (nParents < 2):
        continue
...
for ntrkBin in ntrkList:
    ...
    ATLASLabel(0.20, 0.955, label)
    leg.Draw()
    c.Print("{}/{}.pdf".format(directory, "mvMass_allCategory_"+ntrkBin))
